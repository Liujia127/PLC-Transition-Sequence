...
for i, ax in enumerate(axes.flat):
    ...
    # 添加注释到右上角
    annotation_text = f"frequent>{10-i * 2}"
...
fig.text(0.5, 0.02, "Parent", ha="center", fontsize=14)
fig.text(0.02, 0.5, "Number of tracks (%)", va="center", rotation="vertical", fontsize=14)
fig2.suptitle("Matched-degree", fontsize=16)
fig2.text(0.5, 0.02, "Parent", ha="center", fontsize=14)
fig2.text(0.02, 0.5, "Length of sequence (%)", va="center", rotation="vertical", fontsize=14)
